package com.zayyan.ruangbacafasilkom.activity //PinjamPJGActivity
...
class PinjamPJGActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_pinjam_pjg)
        ...
        RetrofitClient.instance.getriwayatpinjam(username).enqueue(object : Callback<RiwayatPinjam> {
            ...
            override fun onFailure(call: Call<RiwayatPinjam>, t: Throwable) {
                progressDialog.dismiss()
                Toast.makeText(this@PinjamPJGActivity, "Ulangi Kembali Internet Bermasalah", Toast.LENGTH_LONG).show()
            }
        })
        ...
        RetrofitClient.instance.apicekpinjam(
            ...
            override fun onFailure(call: Call<Cekpinjam>, t: Throwable) {
                ...
                Toast.makeText(this@PinjamPJGActivity, "Internet Bermasalah", Toast.LENGTH_LONG).show()
            }
        })
    }
                ...
                override fun onResponse(call: Call<RiwayatPinjamNew>, response: Response<RiwayatPinjamNew>) {
                    ...
                    if (response.isSuccessful()) {
                        ...
                        try {
                            ...
                            progressDialog.dismiss()
                            Toast.makeText(this@PinjamPJGActivity, pesan, Toast.LENGTH_LONG).show()
                        }catch (e: java.lang.Exception){
                            progressDialog.dismiss()
                            Toast.makeText(this@PinjamPJGActivity, "Judul : "+setresult+" \n"+pesan, Toast.LENGTH_LONG).show()
                        }
                    } else {
                        progressDialog.dismiss()
                        Toast.makeText(this@PinjamPJGActivity,"Gagal "+response,Toast.LENGTH_LONG).show()
                    }
                }
